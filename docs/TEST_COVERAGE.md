...
**Last refreshed:** 2026-05-08 (customerLookup helper +4 + customer-persistence regressions +3 backend, all driven by the agent-tools customer-create-as-separate-transaction refactor; backend 1,659 → 1,666)
