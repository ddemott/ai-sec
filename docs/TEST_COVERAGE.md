...
|---|---|---|---|
| Backend (`npm test`) | 1,781 / 1,781 | ✅ | ~120s |
| Dashboard (`cd dashboard && npm test`) | 620 / 620 | ✅ | ~10s |
| Agent (`cd agent && npm test`) | 85 / 85 | ✅ | ~3s |
| Playwright e2e (`cd dashboard && npx playwright test`) | 71 passed, 7 skipped | ✅ | ~130s |

Total unit tests: 2,401 passing (backend + dashboard) + 85 agent.
