...
Total unit tests: ~3,846 passing (~2,333 backend + ~1,017 dashboard + ~496 agent). Counts are the 2026-07-09 CLAUDE.md figures; re-run for exact numbers.
