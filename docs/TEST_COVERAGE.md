...
Total unit tests: ~3,694 passing (~2,324 backend + ~874 dashboard + ~496 agent). Counts are the 2026-07-07 CLAUDE.md figures; re-run for exact numbers.
