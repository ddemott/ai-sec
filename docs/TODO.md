...
- [ ] **(code)** **Finish the dashboard component subdirectory migration** — **66** loose `.tsx` files at `dashboard/components/` (count 2026-08-28: was 68 after communications slice). Fifth slice: BillingView → `components/billing/`.
...
- [ ] Continue count-drift passes (route modules / migrations / test numbers) after any new route or migration; keep secondary docs synced. **2026-08-28 pass:** dashboard loose `.tsx` at `components/` is **66** (billing slice); `supabase/migrations/` still **189**.
