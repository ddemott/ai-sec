...
- [x] **`GET /communications/history` implemented** (PR `feat/communications-history`) — real `communications_history` table (migration `20260612000000`), written on the EmailService/SMSService send success path, tenant-scoped paginated query. No live UI consumer yet (backend-only).
