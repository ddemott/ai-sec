...
- [ ] **(code)** **Finish the dashboard component subdirectory migration** — **89** loose `.tsx` files at `dashboard/components/` (count corrected 2026-08-28; was listed as 49).
...
- [ ] Continue count-drift passes (route modules / migrations / test numbers) after any new route or migration; keep secondary docs synced. **2026-08-28 pass:** dashboard loose `.tsx` at `components/` is **89** (TODO had 49); `supabase/migrations/` still **189**.
