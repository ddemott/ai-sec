...
- [ ] **Audit Front Desk view for non-technical operators — IN PROGRESS.** Audit shipped 2026-05-07 (`docs/sessions/2026-05-07-front-desk-audit.md`); walked every primary task (book a call-in, look up tomorrow's schedule, mark someone unavailable, find a customer) and produced a six-item priority punch list (3 P0 launch-blockers, 3 P1/P2 polish). Punch list status: **all 3 P0 items done 2026-05-07** — #1 Quick Book hoist (`1b60b48`), #2 Mark off today on `StaffProfileCard`, #3 searchable customer combobox via shared `CustomerCombobox` extraction. P1/P2 items 4–6 open. Track punch-list close-out in the audit doc, not here.
