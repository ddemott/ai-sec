...
describe('public legal pages', () => {
  ...
  it('dpa is a Bonterms v2.0 cover with a subprocessor list', () => {
    ...
    expect(screen.getByRole('link', { name: /Bonterms Data Protection Addendum Version 2.0/i })).toHaveAttribute(
      'href',
      'https://bonterms.com/standard/dpa-v2-cover-page-version'
    );
