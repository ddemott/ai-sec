...
<nav id="main-nav">
  ...
  <div class="nav-cta">
    <a href="tel:+16308669160" class="nav-phone" aria-label="Call our demo line">
      <svg viewBox="0 0 24 24" style="width:13px;height:13px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;vertical-align:middle;margin-right:5px"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 014 12.5a19.8 19.8 0 01-3-8.61A2 2 0 013 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L7.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>(630) 866-1960
    </a>
...
<div class="nav-mobile-menu" id="mobile-menu" role="navigation" aria-label="Mobile navigation">
  ...
  <div class="nav-mobile-cta">
    <a href="tel:+16308669160" style="font-family:var(--ff-mono);font-size:14px;color:var(--blue-lt);text-decoration:none;text-align:center;padding:10px 0;">(630) 866-1960 — try it live</a>
    <a href="/dashboard" class="btn-login">Log in</a>
    <a href="/register" class="btn-primary">Start free trial</a>
  </div>
</div>
...
<section class="cta-band">
  ...
  <div class="cta-band-actions reveal reveal-delay-2">
    ...
    <div class="cta-number">
      ...
      <span style="color:var(--blue-lt)">(630) 866-1960</span>
    </div>
  </div>
</section>
