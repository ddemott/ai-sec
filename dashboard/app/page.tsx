  ...
  <div class="hero-inner">
    ...
    <div class="feat-grid-hero reveal reveal-delay-2">
      ...
      <div class="feat-tile">
        ...
        <div class="feat-tile-h">Answers Every Call</div>
        <p class="feat-tile-p">Real phone number. Live 24/7. Picks up before the second ring, in a natural human voice.</p>
      </div>
      ...
      <div class="feat-tile">
        ...
        <div class="feat-tile-h">Works After Hours</div>
        <p class="feat-tile-p">Takes bookings at midnight the same as at noon. No voicemail, no missed opportunity.</p>
      </div>
