        ...
        <div className="p-8">
          {submitted ? (
            <div role="status" className="text-sm" style={{ color: 'var(--text-primary)' }}>
              <p className="mb-4">If an account exists for that email, a reset link has been sent.</p>
              <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>The link expires in 30 minutes. Check your inbox (and spam folder).</p>
              <a href="/dashboard" className="inline-flex items-center text-sm hover:underline" style={{ color: 'var(--accent)' }}>
