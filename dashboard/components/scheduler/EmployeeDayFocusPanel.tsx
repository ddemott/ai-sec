      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-4 border-b border-gray-100 dark:border-gray-800">
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="text-center">
              <div className={`text-2xl font-bold ${utilization >= 80 ? 'text-green-600 dark:text-green-400' : utilization >= 50 ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-500'}`} data-testid="focus-utilization">
                {utilization}%
              </div>
              <div className="text-xs text-gray-400 dark:text-gray-500 uppercase font-bold">Utilization</div>
            </div>
          </div>
        </div>
        ...
        {shifts.length > 0 && (
          <div className="p-4 border-b border-gray-100 dark:border-gray-800">
            <h4 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase mb-2">Shifts</h4>
        ...
        <div className="p-4">
          <h4 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase mb-3">Timeline</h4>
          {sorted.length === 0 ? (
