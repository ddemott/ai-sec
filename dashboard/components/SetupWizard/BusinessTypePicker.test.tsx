...
describe('BusinessTypePicker', () => {
  ...
  describe('Happy Paths', () => {
    test('renders modal with header and search', async () => {
      render(<BusinessTypePicker onSelect={mockOnSelect} onClose={mockOnClose} onBack={mockOnBack} />)
    ...
    test('search filters templates by display_name', async () => {
      ...
      fireEvent.change(screen.getByPlaceholderText('Search business types...'), { target: { value: 'salon' } })
    ...
    test('search filters templates by category', async () => {
      ...
      fireEvent.change(screen.getByPlaceholderText('Search business types...'), { target: { value: 'auto' } })
    ...
    test('search auto-expands all matching categories', async () => {
      ...
      fireEvent.change(screen.getByPlaceholderText('Search business types...'), { target: { value: 'shop' } })
  ...
  describe('Sad Paths', () => {
    ...
    test('shows no results message when search has no matches', async () => {
      ...
      fireEvent.change(screen.getByPlaceholderText('Search business types...'), { target: { value: 'xyznonexistent' } })
  ...
  describe('Edge Cases', () => {
    ...
    test('clearing search restores all categories collapsed', async () => {
      ...
      // Clear search
      fireEvent.change(screen.getByPlaceholderText('Search business types...'), { target: { value: '' } })
