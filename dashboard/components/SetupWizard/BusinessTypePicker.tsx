      ...
      >
        ...
        <div className="flex-1 overflow-auto px-6 py-3">
          {loading ? (
            ...
            <p className="text-sm text-gray-400 py-4 text-center">No matching business types found.</p>
          ) : (
                  ...
                  <div key={cat}>
                    ...
                    >
                      ...
                      <span className="flex items-center gap-2">
                        <span className="text-xs font-normal" style={{ color: 'var(--text-secondary)' }}>{items.length}</span>
                        <ChevronRight className={`w-4 h-4 transition-transform ${isExpanded ? 'rotate-90' : ''}`} style={{ color: 'var(--text-secondary)' }} />
                      </span>
                    </button>
                    {isExpanded && (
        ...
        {/* Footer */}
        <div className="px-6 py-3 border-t shrink-0 flex justify-start" style={{ borderColor: 'var(--border)' }}>
          <button
            onClick={onBack}
