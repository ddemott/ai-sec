      ...
      <div className="p-4 md:p-8 space-y-8 max-w-4xl">
                    ...
                    <button
                      onClick={async () => {
                        ...
                        try {
                          ...
                          const msg =
                            err instanceof Error ? err.message : 'Failed to activate phone';
                          showToast(msg, 'error');
                        }
                      }}
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            {/* Voice — a dropdown of the valid OpenAI TTS voices the agent
                actually uses (writes tts_voice). Replaces the old free-text
                "Voice ID" (voice_id), which the agent ignored — a typo there
                (e.g. "clara") silently did nothing. */}
            {isEditing ? (
              <div className="space-y-1">
                <label
                  className="text-xs font-bold uppercase ml-1 flex items-center"
