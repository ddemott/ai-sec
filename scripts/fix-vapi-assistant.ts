 ...
 * 
 * This script updates the Vapi assistant's system prompt to:
 * - Use current date dynamically
 * - Instruct AI to extract service type and pass as requiredEmployeeSkills
 * - Improve phone number handling instructions
 */
