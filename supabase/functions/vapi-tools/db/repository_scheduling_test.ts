...
Deno.test({
  ...
  async fn() {
    ...
    await client.queryArray("INSERT INTO resources (tenant_id, name, description, is_active) VALUES ($1, 'Other Tenant Truck', 'Other', true)", ["00000000-0000-0000-0000-000000000000"]);
...
Deno.test({
  ...
  async fn() {
    ...
    await client.queryArray(
      "INSERT INTO appointments (tenant_id, resource_id, customer_id, start_time, end_time, status) VALUES ($1, $2, $3, $4, $5, 'scheduled')",
      ["00000000-0000-0000-0000-000000000000", resourceId, customerId, "2026-10-01T10:15:00Z", "2026-10-01T10:45:00Z"],
    );
