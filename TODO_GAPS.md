...
- [ ] **Gate Railway deploys on CI green** — currently auto-deploys any push to `main` without waiting for tests (P0, hardest to fix silently)
  ...
  - [ ] Update all references across `docs/TODO.md`, `CLAUDE.md`, `docs/DEVELOPMENT_WORKFLOW.md`, `README.md` (and the protection doc itself) to document that merges now require green CI and Railway deploys are gated behind protected merges
